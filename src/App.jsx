...
{/* table */}
    <div className='flex bg-[#EBF0F5] w-[90%] gap-10 mx-auto h-[1100px] '>
      ...
      <div className='rightSide overflow-y-auto w-[40%] card flex flex-col rounded-2xl  bg-[#FFFFFF]'>
    


    <div className='flex border-b-2 border-gray-400 text-center '>
...
<h2 className='text-[#102A53] font-bold capitalize text-xl mt-10 mb-5 '>favorite items</h2>
